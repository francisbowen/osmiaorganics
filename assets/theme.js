...
// Product Description Read More and Read Less
$(document).ready(function(){
  length = 175;
  cHtml = $(".product-description-mobile").html();
  cText = $(".product-description-mobile").text().substr(0, length).trim();
  $(".product-description-mobile").addClass("compressed").html(cText + "... <a href='#' class='exp border-0'>more</a>");
  window.handler = function()
  {
      $('.exp').click(function(){
          if ($(".product-description-mobile").hasClass("compressed"))
          {
              $(".product-description-mobile").html(cHtml + "<a href='#' class='exp border-0'>less</a>");
              $(".product-description-mobile").removeClass("compressed");
              handler();
              return false;
          }
          else
          {
              $(".product-description-mobile").html(cText + "... <a href='#' class='exp border-0'>more</a>");
              $(".product-description-mobile").addClass("compressed");
              handler();
              return false;
          }
      });
...
$(document).ready(function(){
  $(".product-single__thumbnail").click(function(){
   $(".product-video-icon").fadeOut('fast');
  });
  $(".video-thumb").click(function(){
    
   $(".product-video-icon").fadeIn('slow');
  });
...
$(document).ready(function(){
  $(".shopping-cart .fa-window-close").click(function(){
